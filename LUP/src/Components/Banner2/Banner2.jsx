...
export const Banner2 = () => {
  return (
    <main className='Banner2'>
<div className='Banner2Container'>
<div className='Banner2Titulo'>
    <h2> LA MAGIA DE LA MÚSICA EN VIVO </h2>
    <h2>Y EL MOOD CHILL DE UNA SESIÓN ÍNTIMA</h2>
</div>

<div className='Banner2Parrafo'>
<p>
Proponemos un escenario en donde podrás sumergirte en una experiencia única y cinematográfica; creada exclusivamente para musicxs, bandas y artistas como tú.
